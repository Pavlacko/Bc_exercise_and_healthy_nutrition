...
namespace Bc_exercise_and_healthy_nutrition.Migrations
{
    ...
    [Migration("20260410123109_AddProfileVisibility")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bc_exercise_and_healthy_nutrition.Models.FriendRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bc_exercise_and_healthy_nutrition.Models.FriendRequest", b =>
                {
                    b.HasOne("Bc_exercise_and_healthy_nutrition.Models.AppUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Bc_exercise_and_healthy_nutrition.Models.AppUser", "Sender")
                        .WithMany()
